print("Welcome to this Mads Libs Game!")

#user input
verb1 = str(input("Choose a verb: "))
noun4 = str(input("Choose a noun: "))
verb2 = str(input("Choose a verb: "))
...
print(f"""One day, {name1} decided to go on an adventure to the {adjective1} land of {noun}. 
      ...
      Excited, they accepted and continued their journey until they reached a {adjective3} {place}. 
      ...
      Thrilled with their new gift, they {verb2} all the way back home, where they shared the story of their {adjective5} adventure with everyone. 
